// Simple C program that explores the RBN(Random Boolean Network) configuration network . Originally written by Yi-Kai Mo 06/2023
...
int main(int argc, char *argv[]){
    ...
    if (argc == 8){
        ...
        fprintf(stderr,"Usage: RBNconfig.x N k p seedt in-degreefile booleanfile confignetfile\n");
        return 1;
    }
