...
int main(int argc, char *argv[]){
  ...
  if (argc == 10){
    ...
    fprintf(stderr,"Usage: main.x N K P(population) G(Num of Generation) seedS(Structure) seedB(Boolean) seedI(Initial states) p(Probability for Boolean function) eps(Mutation Probability)\n");
    return 1;
  }
